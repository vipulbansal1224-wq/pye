...
import { Product, Category } from "../../lib/dataLoader";
...
function ProductsCatalogContent({ products, categories }: ProductsCatalogClientProps) {
...
export default function ProductsCatalogClient({ products, categories }: ProductsCatalogClientProps) {
  return (
